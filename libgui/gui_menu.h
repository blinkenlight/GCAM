...
static GtkActionEntry gui_menu_entries[] = {
  ...
  { "Attract Previous",            GTK_STOCK_GOTO_LAST,      "Attract _Previous",            "<alt><control>P",   "Attract Previous",                 G_CALLBACK (gui_menu_edit_attract_previous_menuitem_callback) },
  { "Attract Next",                GTK_STOCK_GOTO_FIRST,     "Attract _Next",                "<alt><control>N",   "Attract Next",                     G_CALLBACK (gui_menu_edit_attract_next_menuitem_callback) },
  ...
  { "Flip Direction",              GTK_STOCK_REFRESH,        "F_lip Direction",              NULL,                "Flip Direction",                   G_CALLBACK (gui_menu_edit_flip_direction_menuitem_callback) },
  { "Optimize Order",              GTK_STOCK_SORT_ASCENDING, "_Optimize Order",              NULL,                "Optimize Order",                   G_CALLBACK (gui_menu_edit_optimize_order_menuitem_callback) },
  { "Generate Pattern",            NULL,                     "_Generate Pattern",            NULL,                "Generate Pattern",                 G_CALLBACK (gui_menu_edit_generate_pattern_menuitem_callback) },
  ...
  { "Polygon",                     NULL,                     "_Polygon",                     NULL,                "Create Polygon",                   G_CALLBACK (gui_menu_assistant_polygon_menuitem_callback) },
  { "ViewMenu",                    NULL,                     "_View" },
